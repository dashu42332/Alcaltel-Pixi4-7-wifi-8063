...
###add recovery & updater by wqj begin
  PRODUCT_PACKAGES += updater \
                 recovery
###add recovery & updater by wqj end
...
###hany 20150522 add for 3rd-apk begin###
PRODUCT_PACKAGES += JrdElabel
###hany 20150522 add for 3rd-apk end###

###yuhuan 20160127 add for mmi begin###
PRODUCT_PACKAGES += MMITestdev
###yuhuan 20160127 add for mmi end###
###yuhuan 20160127 add for TP0 test apk begin###	
PRODUCT_PACKAGES += RawDataTest_v1.8.4_public_20160315
###yuhuan 20160127 add for TP0 test apk end###

###liudongming 20160127 add for TP0 test ini begin###	
PRODUCT_PACKAGES += test_sensor_0.ini
PRODUCT_PACKAGES += test_sensor_2.ini
PRODUCT_PACKAGES += test_sensor_3.ini
PRODUCT_PACKAGES += test_sensor_5.ini
PRODUCT_PACKAGES += libopenshort.so
###liudongming 20160127 add for TP0 test ini end###
...
#yuhuan  20160127 add
PRODUCT_PROPERTY_OVERRIDES += persist.sys.mmi.calibration=unknown
...
PRODUCT_PROPERTY_OVERRIDES +=persist.uartconsole.enable=1
endif
